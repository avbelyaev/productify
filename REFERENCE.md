...
из которых генерятся эти самые client-stub и server-stub для любого языка. 
...
P.S.  
Знать почему мы пишем ретраи в коде и обрабатываем HTTP-статусы - однозначно надо. я попытался это кратко объяснить.
