...
В общем теперь мы научились заходить в контейнер и работать с ним как со стандартным линуксом.


Если тебе это интересно, то да, в докере можно запустить докер. А в том другой и так далее... :)
...
- полный список команд см в докумнтации: https://docs.docker.com/engine/reference/builder/    
