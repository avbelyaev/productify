...
- файл со стилями, чтобы смотрелось красиво (но поначалу можно не заморачиваться)
...
- существуют _абсолютные_ и _относительные_ адреса - ты это, думаю, знаешь. 
    ...
    - запрос можно сделать *только скобрав полный (абсолютный) URL* (ведь нам нужно получить ip-адрес по hostname'у от DNS, но hostname'а в отнсительном адресе нет)
