...
К этому моменту приложение должно уже быть развернуто и ты должна уже мочь обновить версию приложения

## Step 8 Database

Подключение базы данных (какой?), сохранение запросов, логов
